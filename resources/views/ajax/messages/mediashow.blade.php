                ...
                <div class="chat">
                    <div class="chat-container">
                        <div class="user-bar">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('assets/images/logo-sigma.png') }}" alt="Avatar">
                            </div>
                            <div class="name">
                                <span>Tim Data</span>
                            ...
                            <div class="conversation-container">
                                ...
                                <div class="message sent">
                                    @if ($message->type == 'image')
                                        <img src="{{ $message->url }}" alt="{{ $message->filename ?? 'Image' }}" width="250px" height="150px"><br>
                                    ...
                                    @elseif ($message->type == 'document')
                                        <b class="" onclick="window.open('{{ $message->url }}')">
                                            📄 {{ $message->filename ?? basename($message->url) }}
                                        </b>
                                        </br>
                                    ...
                                    @if(!empty($message->caption))
                                        <div class="media-caption" style="margin-top: 8px;">
                                            {!! nl2br(e($message->caption)) !!}
                                        </div>
                                    @endif
                                    <span class="metadata">
