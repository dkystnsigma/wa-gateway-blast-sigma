                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                @if ($campaigns->total() == 0)
                                    <x-no-data colspan="6" text="No Autoreplies added yet"
                                        text="No Campaigns added yet" />
                                @endif
                                @foreach ($campaigns as $campaign)
                                    <tr>
                                        <td>{{ $campaign->form_order_id ?? '-' }}</td>
                ...
                <div class="card-body">
                    <form class="row g-3">
                        <div class="col-12">
                            ...
                            <input value="{{ request()->has('device') ? request()->device : '' }}" type="number"
                                name="device" class="form-control" placeholder="Order ID">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Status</label>
                            <select name="status" class="form-select">
                                <option {{ request()->has('status') && request()->status == 'all' ? 'selected' : '' }}
