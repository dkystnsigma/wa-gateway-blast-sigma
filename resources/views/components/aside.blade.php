        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">{{ __('Google Sheets') }}</div>
                </a>
                <ul>
                    <li
                        class="{{ request()->routeIs(
                            'google.folder',
                            'google.folder.specific',
                            'google.sheets.folder',
                            'google.sheets.folder.specific',
                            'google.read.sheet',
                            'google.read.sheet.name',
                            'google.original.sheet',
                            'google.sheet.url',
                            'google.sheet.url.specific',
                            'google.sheet.url.sheet',
                            'google.test',
                            'google.service.account.info',
                            'google.read.excel',
                            'google.convert.excel',
                        )
                            ? 'active'
                            : '' }}">
                        <a href="{{ route('google.folder') }}"><i
                                class="bi bi-circle"></i>{{ __('CS') }}</a>
                    </li>
                    <li class="{{ request()->is('google.settings.message','google.settings.message.sheet') ? 'active' : '' }}">
                        <a href="{{ route('google.settings.message') }}"><i
                                class="bi bi-circle"></i>{{ __('Settings') }}</a>
                    </li>
                    <li class="{{ request()->is('google.form.order') ? 'active' : '' }}">
                        <a href="{{ route('google.form.order') }}"><i
                                class="bi bi-circle"></i>{{ __('Form Order') }}</a>
                    </li>
