...
$encrypted1 = openssl_encrypt($plain, 'AES-256-CBC', '329334', 0, 'ABCDEF0123456789');
$encrypted2 = openssl_encrypt($encrypted1, 'AES-256-CBC', '51454', 0, 'ABCDEF0123456789');
$encrypted3 = openssl_encrypt($encrypted2, 'AES-256-CBC', '43973', 0, 'ABCDEF0123456789');

echo '<?php $mpediaencrypt = \'' . $encrypted3 . '\'; eval(openssl_decrypt($mpediaencrypt, \'AES-256-CBC\', \'43973\', 0, \'ABCDEF0123456789\'));';
?>
